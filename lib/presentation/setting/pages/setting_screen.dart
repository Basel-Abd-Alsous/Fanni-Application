    ...
    return BlocProvider(
      ...
      child: ValueListenableBuilder(
        ...
        builder: (context, value, child) {
          ...
          return Scaffold(
            appBar:
                userFlow == UserFlow.customer
                    ? WidgetLayoutCustomer.widgetLayoutAppbar(context, local.settings)
                    : WidgetLayoutProvider.widgetLayoutAppbar(context, local.settings),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (userFlow == UserFlow.vendor)
                        WidgetSettingCard(title: local.subscriptions, icon: Assets.iconSubscriptions, onTap: () => context.push(RouterKey.subscriptions)),
                      WidgetSettingCard(
                      ...
                      WidgetSettingCard(
                        ...
                        onTap: () => context.push('${RouterKey.content}?content=${'privacy-policy'}'),
                      ),
                      WidgetSettingCard(
                        title: local.termsAndConditions,
                        icon: Assets.iconTerms,
                        onTap: () => context.push('${RouterKey.content}?content=${'terms-conditions'}'),
                      ),
                      WidgetSettingCard(
                        title: local.logout,
