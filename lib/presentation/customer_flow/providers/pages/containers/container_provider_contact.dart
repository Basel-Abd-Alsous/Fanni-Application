                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: InkWell(
                              onTap: () async => await context.read<MerchantsCubit>().merchantInteraction(data?.data?.data?.id ?? 0, 'call', data?.data?.data?.mobileNumber ?? ''),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  spacing: 5,
                                  children: [const Icon(Icons.phone, color: AppColor.green, size: 25), Text(local.callNow, style: AppTextStyle.style13B.copyWith(color: AppColor.primaryColor))],
                                ),
                              ),
                            ),
                          ),
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: () async => await context.read<MerchantsCubit>().merchantInteraction(data?.data?.data?.id ?? 0, 'whatsapp', data?.data?.data?.mobileNumber ?? ''),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  spacing: 5,
                                  children: [SvgPicture.asset(Assets.iconWhatsapp, width: 25), Text(local.whatsapp, style: AppTextStyle.style13B.copyWith(color: AppColor.primaryColor))],
                                ),
                              ),
                            ),
                          ),
