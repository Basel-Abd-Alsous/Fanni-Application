...
class _WidgetPhoneFieldState extends State<WidgetPhoneField> {
  ...
  void didUpdateWidget(covariant WidgetPhoneField oldWidget) {
    ...
    if (widget.code != null && widget.code != oldWidget.code) {
      setState(() {
        number = PhoneNumber(isoCode: widget.code!.toUpperCase());
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: InternationalPhoneNumberInput(
        ...
        errorMessage: widget.hint != null || hasText ? null : widget.message ?? 'required',
        onFieldSubmitted: widget.onFieldSubmitted,
        keyboardAction: TextInputAction.next,
        hintText: widget.hint ?? 'XX XXXXXXXX',
        ...
        selectorTextStyle: AppTextStyle.style14,
        countries: const [
          'JO',
          'AE',
          'IQ',
