...
import '../../presentation/notification/widget/widget_notification.dart';
...
class _LoadingAllNotificationState extends State<LoadingAllNotification> {
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) => WidgetNotificationList(title: '', date: DateTime.now(), desc: '', loading: true),
    );
  }
}
